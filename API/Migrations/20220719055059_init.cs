        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "enum('SocialCulture','NaturalTourism', 'Food', 'Hotel')", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_m_destination", x => x.id);
                    table.ForeignKey(
                        name: "FK_tb_m_destination_tb_account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "tb_account",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_m_destination_tb_m_category_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_m_destination_AccountId",
                table: "tb_m_destination",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_tb_m_destination_CategoryId",
                table: "tb_m_destination",
                column: "CategoryId");
